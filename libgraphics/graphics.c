...
static void InitColors(void)
{
    ...
    DefineColor("PunkBlack", .06, .06, .24);
    ...
    DefineColor("PunkPink",.86,.27,.57);
    DefineColor("PunkRed",.92,0,.32);
    DefineColor("PunkDarkBlue",.019,.019,.36);
    DefineColor("PunkLightBlue",.25,.69,.94);
    DefineColor("PunkBlue",.2,.67,.89);
    DefineColor("PunkPurple",.32,.27,.73);
    DefineColor("PunkDarkPurple",.09,.05,.17);
    DefineColor("PunkOrange",.98,.52,.21);
    DefineColor("PunkYellow",1,.9,.2);
    DefineColor("TraBack",.81,.75,.68);
    DefineColor("TraRed",.75,0,0);
    DefineColor("TraYellow",.75,.51,.29);
    DefineColor("TraBrown",.55,.23,.13);
    DefineColor("TraGreen",.35,.47,.42);
    DefineColor("TraGold",.84,.68,.32);
    DefineColor("TraPurple",.69,.63,.80);
    DefineColor("TraBlue",.43,.52,.72);
    
    DefineColor("AhaPink",.87,.61,.54);
    DefineColor("AhaGreen",.65,.77,.73);
    DefineColor("AhaBlue",.21,.32,.45);
    DefineColor("AhaWhite",.85,.81,.77);
    DefineColor("AhaDGreen",.28,.51,.56);
    DefineColor("AhaYellow",.81,.74,.54);
